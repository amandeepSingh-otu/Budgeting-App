...
export default function Budget(){
    ...
    const{totalBudget,setTotalBudget}=useSharedState();
    ...
    return(<>
        <div className="row pl-5">
            <div className='col-sm-3.5 alert alert-primary'>
                Total Budget: <input type="number" className="d-inline m-1" id="totalBudget" placeholder="Enter Total budget" name="totalBudget" onChange={handleTotalBudgetChange}/>
            </div>
            <div className="col-sm-2 alert alert-primary p-3 ml-2">
                Remaining: $
            </div>
            <div className="col-sm-2 alert alert-primary p-3 mr-2 ml-2">Spent so far: $</div>
